"use strict";
const SecQuadGeomatry = function(gl) {
//ground plane, make a object in scene, use it for a mssh
  this.gl = gl;
  ...
  gl.bufferData(gl.ARRAY_BUFFER,
    new Float32Array([
      ...
      0, 0, 1, 0,
     -1, 0, -1, 0, 
    ]),//第三列shows the z value, the first and second row shows x and y value of triangle
    gl.STATIC_DRAW);
...
SecQuadGeomatry.prototype.draw = function() {
  const gl = this.gl;
