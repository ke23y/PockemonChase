...
const TexturedQuadGeometry = function(gl) {
  ...
  //set it up to the environment mesh, 
  //sey keyTectue to tube texture
  //material.CubeTexture.set(keyTectue)
  ...
  gl.bufferData(gl.ARRAY_BUFFER,
    ...
    //the third row shows the z value, the first and second row shows x and y value of triangle
    gl.STATIC_DRAW);
